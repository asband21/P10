...
def parse_args():
    ...
    parser.add_argument("--minimum-fri", type=float, default=20000)
...
images_train, labels_train, images_test, labels_test, n_chunks = lode_data(min_fri=minimum_fri, batch_size = batch_size, d=data_frak)
